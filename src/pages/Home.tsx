        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left animate-slide-up">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-800 mb-6 leading-tight">
              Des jouets qui{' '}
              <span className="text-coral-400">éveillent</span>,{' '}
              <span className="text-sky-400">inspirent</span> et font{' '}
              <span className="text-yellow-400">grandir</span> !
            </h1>

            <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-xl mx-auto lg:mx-0">
              Parce que la vraie intelligence se construit loin des écrans — découvrez nos jouets éducatifs et accessoires pour enfants, livrés partout au Sénégal.
            </p>
            ...
            <div className="mt-6 flex items-center justify-center lg:justify-start gap-2">
              ...
              <a href="https://www.instagram.com/ekidsstore/" target="_blank" rel="noopener noreferrer"
          ...
          <div className="relative animate-scale-in">
            <div className="relative z-10">
              <img
                src="https://images.unsplash.com/photo-1566576912321-d58ddd7a6088?w=600&h=500&fit=crop"
                alt="Enfants heureux jouant avec des jouets éducatifs"
